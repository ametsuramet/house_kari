      ...
      {loading ? (
        ...
        <div>
          {results.articles.length > 0 ? (
            <div className={styles.section5}>
              <div className={styles.space_between_heading}>
                <h1 className={styles.heading_main_red}>{t('headingArticlesSearch')}</h1>
              </div>
              <SlideArticlesSecond
            ...
            {results.products.length > 0 ? (
              <div className={styles.product_layout}>
                ...
                <div className={styles.space_between_heading}>
                  <h1 className={styles.heading_main_white}>{t('productSearchHeading')}</h1>
                </div>
          ...
          <div className={styles.section5}>
            ...
            <div className={styles.space_between_heading}>
              <h1 className={styles.heading_main_red}>{t('headingRecipeSearch')}</h1>
            </div>
